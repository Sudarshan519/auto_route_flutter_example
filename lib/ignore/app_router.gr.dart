...
import 'package:autoroute_app/ignore/unknown_route/ml_vision.dart' as _i4;
...
import 'package:autoroute_app/ignore/unknown_route/text_recognition.dart'
    as _i5;
import 'package:autoroute_app/ignore/unknown_route/unknown_route.dart' as _i6;
...
abstract class $AppRouter extends _i7.RootStackRouter {
  ...
  final Map<String, _i7.PageFactory> pagesMap = {
    ...
    RenderWidgetBackgroundVisibleCenterGreyedOvalRoute.name: (routeData) {
      return _i7.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i3.RenderWidgetBackgroundVisibleCenterGreyedOvalPage(),
      );
    },
    MlVisionRoute.name: (routeData) {
      return _i7.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i4.MlVisionPage(),
      );
    },
    OCRTextRecognitionRoute.name: (routeData) {
      final args = routeData.argsAs<OCRTextRecognitionRouteArgs>();
      return _i7.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i5.OCRTextRecognitionPage(
          key: args.key,
          number: args.number,
        ),
      );
...
/// generated route for
/// [_i3.RenderWidgetBackgroundVisibleCenterGreyedOvalPage]
...
/// generated route for
/// [_i5.OCRTextRecognitionPage]
class OCRTextRecognitionRoute
    extends _i7.PageRouteInfo<OCRTextRecognitionRouteArgs> {
  OCRTextRecognitionRoute({
    _i8.Key? key,
    required String number,
    List<_i7.PageRouteInfo>? children,
  }) : super(
          OCRTextRecognitionRoute.name,
          args: OCRTextRecognitionRouteArgs(
            key: key,
            number: number,
          ),
          initialChildren: children,
  ...
  static const _i7.PageInfo<OCRTextRecognitionRouteArgs> page =
      _i7.PageInfo<OCRTextRecognitionRouteArgs>(name);
}

class OCRTextRecognitionRouteArgs {
  const OCRTextRecognitionRouteArgs({
    this.key,
  ...
  @override
  String toString() {
    return 'OCRTextRecognitionRouteArgs{key: $key, number: $number}';
  }
}
